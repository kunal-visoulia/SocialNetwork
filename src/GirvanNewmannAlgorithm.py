'''based on edge betweeness:intercomm edges have high value ofbetweenes, means, a number of shrtest paths pass through these edges.If we  find the edge betweeness of these edges and keep removing them we tend to get the community structure'''
...
def edge_to_remove(G):
    ...
    # how we sort a list of tuples baesd on second vale of the yuples in the list
